...
public class AboutProgram extends JDialog{
    ...
    public void createGUI(){
        ...
        String aboutProgram = "Программа \"Библиотека Thoth_lib_m\": \n" +
                                "  Версия: v1.0.0 \n" +
                                "  Лицензия: \n" + 
                "     1. Используя программу \"Thoth_lib_m\" Вы соглашаетесь" + 
                " со всеми пунктами данного лицензионного соглашения.\n" + 
                "     2. Программа \"Thoth_lib_m\" предоставляется по данной " + 
                "лицензии \"AS-IS\" (\"КАК ЕСТЬ\").\n" +
                "     3. Программу разрешено копировать и запускать " +
                "на неограниченном количестве компьютеров.\n" +
                "     4. Программу разрешено изменять и распространять в " +
                "изменённом виде только с сохранением имени первоначального " +
                "автора Sirota Dmitry (Россия, НИУ ИТМО).\n" +
                "     5. Первоначальный автор не несёт ответственности за " +
                "любой возможный или причинённый ущерб и/или убытки " + 
                "кому-либо или чему-либо, а также за потерянную полностью " + 
                "или частично прибыль в результате использования данной " +
                "программы (оригинала) или изменённой кем-либо или чем-либо " +
                "её копии.\n" +
